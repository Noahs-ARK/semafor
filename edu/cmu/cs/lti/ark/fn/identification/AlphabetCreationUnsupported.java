 ...
 * All Rights Reserved.
 * 
 * AlphabetCreationUnsupported.java is part of SEMAFOR 2.0.
 * 
...
public class AlphabetCreationUnsupported	
{
	...
	private Map<String, THashMap<String, Set<String>>> mWordNetMap = null;
	...
	public static void main(String[] args)
	{
		...
		AlphabetCreationUnsupported alph = 
			new AlphabetCreationUnsupported(alphabetFile, 
					eventDir, 
					feFile, 
	...
	public AlphabetCreationUnsupported(String alphabetFile,
							String eventDir,
...
//		SerializedObjects.writeSerializedObject(allFeatures, file);
		System.out.println("Processed index:"+index+" alphsize:"+alphabet.size());
		allFeatures=null;
		System.gc();
	}	
}
