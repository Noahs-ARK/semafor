/*
scala -cp ".:target/Semafor-3.0-alpha-05-SNAPSHOT.jar" -J-Xms4g -J-Xmx4g -J-XX:ParallelGCThreads=2 scripts/scoring/SwabhaDiversity.scala meghana_turbo kbest_basic_test
 */
